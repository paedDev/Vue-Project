...
const submitForm = async () => {
  try {
    ...
    toast.success('Added Job Succesfully ')

    router.push('/jobs')
  } catch (error) {
    console.error('Error adding job:', error)
    toast.error(error.message || 'Job was not added')
  } finally {
    ...
    <div class="flex items-center justify-center">
      <div class="border shadow-2xl border-gray-200 h-full w-3xl bg-white p-8 rounded-2xl">
        <div class="text-center mb-8">
          ...
          <h2 class="text-4xl font-bold text-gray-800">Add Job Listing</h2>
          <p class="text-gray-500 mt-2">Fill in the details to post a new job opportunity</p>
        </div>
        ...
        <form action="" @submit.prevent="submitForm" class="space-y-5">
          ...
          <div class="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
            ...
            >
              ...
              <span v-if="formState.isLoading">Submitting...</span>
